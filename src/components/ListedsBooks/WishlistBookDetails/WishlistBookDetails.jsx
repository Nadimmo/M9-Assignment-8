...
const WishlistBookDetails = ({wishlist}) => {
    // console.log(displayBook)
        const {image, author, rating, yearOfPublishing, publisher, totalPages , category, tags, bookName} = wishlist
        ...
        <div className="hero-content flex-col lg:flex-row border-2 border-gray-300 rounded-xl  w-[320px] lg:w-[100%]">
                ...
                <div >
                    ...
                    <div className="text-lg grid grid-cols-2 lg:grid-cols-3 mt-5">
                        ...
                        <Link to={`/books/${wishlist.bookId}`}><p className="mt-5 ml-16 w-[100%] lg:ml-5 lg:mt-0 btn bg-[#23BE0A] rounded-3xl text-white">View Details</p></Link>
                    </div>
                </div>
            </div>
        </div>
